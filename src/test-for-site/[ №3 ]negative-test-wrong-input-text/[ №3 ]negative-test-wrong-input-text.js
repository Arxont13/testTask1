...
const stringXpath = {
    inputForInitialText: "//html/body/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[2]/div[2]/c-wiz[1]/span/span/div",
    btnChangeInitialLanguage: "/html/body/c-wiz/div/div[2]/c-wiz/div[2]/c-wiz/div[1]/div[1]/c-wiz/div[2]/div/div[2]/div/div/span/button[2]/span[3]",
...
let scrape = async () => {
    ...
    await fillInputElement (page,
        await takeElementByXpath(page, stringXpath.inputForInitialText,0, 8000),
        inputText, 0)
    ...
    {
        throw {name: `Test FAILED. Wrong translate from English to English!`}
    }
